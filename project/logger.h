 ...
 *
 * @return LOG_RES_SUCCESS - everything OK,
 * @return LOG_RES_ERROR_PTHREAD - problem with canceling DUMP thread
 */
 ...
 *        level, then message is discarded
 * @param _format Format sting of message
 ...
 * 
 * @param _pid ID of process that should have logging level changed - if `NULL`,
 ...
 *
 * @param _pid ID of process that should have memory dumped - if `NULL`,
 *        then current process receives signal
